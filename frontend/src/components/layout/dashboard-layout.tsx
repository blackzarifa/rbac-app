...
import { FolderOpen, Users, LogOut, LayoutDashboard, Shield, ChevronRight } from 'lucide-react';
          ...
          <div className="p-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem>
                  <span className="text-xs text-muted-foreground">Perfil: {user?.role.name}</span>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem
