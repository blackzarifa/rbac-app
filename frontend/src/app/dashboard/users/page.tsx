...
const roles: Role[] = [
  { id: 1, name: 'admin', permissions: { users: ['create', 'read', 'update', 'delete'], projects: ['create', 'read', 'update', 'delete'], tasks: ['create', 'read', 'update', 'delete'] } },
  { id: 2, name: 'editor', permissions: { projects: ['create', 'read', 'update'], tasks: ['create', 'read', 'update', 'delete'] } },
